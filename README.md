...
This checkout also has some local project notes that are useful before making
changes, running builds, or asking an AI agent to prepare commits:

- [AGENTS.md](AGENTS.md) for agent-specific repo instructions and command
  shortcuts.
- [LOCAL_BUILD_OPTIONS.md](LOCAL_BUILD_OPTIONS.md) for the preferred build,
  run, and install paths for this fork.
- [LOCAL_FORK_WORKFLOW.md](LOCAL_FORK_WORKFLOW.md) for the branch and upstream
  sync workflow used in this repo.
- [AI_POLICY.md](AI_POLICY.md) for Ghostty's AI usage expectations.

## More References

- [PACKAGING.md](PACKAGING.md) for packaging and distribution notes.
- [ghostty.org/docs](https://ghostty.org/docs) for the main upstream
  documentation.
